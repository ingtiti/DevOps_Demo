sealed class DevOps_Demo_FuseControlsPanel_Color_Property: Uno.UX.Property<float4>
{
    Fuse.Controls.Panel _obj;
    public DevOps_Demo_FuseControlsPanel_Color_Property(Fuse.Controls.Panel obj) { _obj = obj; obj.ColorChanged += this.OnValueChanged; }
...
sealed class DevOps_Demo_FuseControlsText_Value_Property: Uno.UX.Property<string>
{
    Fuse.Controls.Text _obj;
    public DevOps_Demo_FuseControlsText_Value_Property(Fuse.Controls.Text obj) { _obj = obj; obj.ValueChanged += this.OnValueChanged; }
...
sealed class DevOps_Demo_FuseControlsText_TextColor_Property: Uno.UX.Property<float4>
{
    Fuse.Controls.Text _obj;
    public DevOps_Demo_FuseControlsText_TextColor_Property(Fuse.Controls.Text obj) { _obj = obj;  }
...
sealed class DevOps_Demo_FuseReactiveEach_Items_Property: Uno.UX.Property<object>
{
    Fuse.Reactive.Each _obj;
    public DevOps_Demo_FuseReactiveEach_Items_Property(Fuse.Reactive.Each obj) { _obj = obj;  }
    protected override object OnGet() { return _obj.Items; }
    protected override void OnSet(object v, object origin) { _obj.Items = v; }
}
sealed class DevOps_Demo_FuseControlsRectangle_Color_Property: Uno.UX.Property<float4>
{
    Fuse.Controls.Rectangle _obj;
    public DevOps_Demo_FuseControlsRectangle_Color_Property(Fuse.Controls.Rectangle obj) { _obj = obj; obj.ColorChanged += this.OnValueChanged; }
    protected override float4 OnGet() { return _obj.Color; }
    protected override void OnSet(float4 v, object origin) { _obj.SetColor(v, origin); }
    protected override void OnAddListener(Uno.UX.ValueChangedHandler<float4> listener) { _obj.ColorChanged += listener; }
    protected override void OnRemoveListener(Uno.UX.ValueChangedHandler<float4> listener) { _obj.ColorChanged -= listener; }
}
sealed class DevOps_Demo_FuseControlsRectangle_Height_Property: Uno.UX.Property<Uno.UX.Size>
{
    Fuse.Controls.Rectangle _obj;
    public DevOps_Demo_FuseControlsRectangle_Height_Property(Fuse.Controls.Rectangle obj) { _obj = obj;  }
...
sealed class DevOps_Demo_PageWithTitle_HeaderColor_Property: Uno.UX.Property<float4>
{
    PageWithTitle _obj;
    public DevOps_Demo_PageWithTitle_HeaderColor_Property(PageWithTitle obj) { _obj = obj; obj.HeaderColorChanged += this.OnValueChanged; }
...
sealed class DevOps_Demo_PageWithTitle_Title_Property: Uno.UX.Property<string>
{
    PageWithTitle _obj;
    public DevOps_Demo_PageWithTitle_Title_Property(PageWithTitle obj) { _obj = obj;  }
    protected override string OnGet() { return _obj.Title; }
    protected override void OnSet(string v, object origin) { _obj.Title = v; }
}
sealed class DevOps_Demo_PageWithTitle_HeaderTextColor_Property: Uno.UX.Property<float4>
{
    PageWithTitle _obj;
    public DevOps_Demo_PageWithTitle_HeaderTextColor_Property(PageWithTitle obj) { _obj = obj; obj.HeaderTextColorChanged += this.OnValueChanged; }
...
sealed class DevOps_Demo_PageWithTitle_Instructions_Property: Uno.UX.Property<string>
{
    PageWithTitle _obj;
    public DevOps_Demo_PageWithTitle_Instructions_Property(PageWithTitle obj) { _obj = obj; obj.InstructionsChanged += this.OnValueChanged; }
...
sealed class DevOps_Demo_FuseControlsRectangle_CornerRadius_Property: Uno.UX.Property<float4>
{
    Fuse.Controls.Rectangle _obj;
    public DevOps_Demo_FuseControlsRectangle_CornerRadius_Property(Fuse.Controls.Rectangle obj) { _obj = obj;  }
...
sealed class DevOps_Demo_FuseControlsRectangle_Opacity_Property: Uno.UX.Property<float>
{
    Fuse.Controls.Rectangle _obj;
    public DevOps_Demo_FuseControlsRectangle_Opacity_Property(Fuse.Controls.Rectangle obj) { _obj = obj;  }
    protected override float OnGet() { return _obj.Opacity; }
    protected override void OnSet(float v, object origin) { _obj.Opacity = v; }
}
sealed class DevOps_Demo_FuseEffectsBlur_Radius_Property: Uno.UX.Property<float>
{
    Fuse.Effects.Blur _obj;
    public DevOps_Demo_FuseEffectsBlur_Radius_Property(Fuse.Effects.Blur obj) { _obj = obj;  }

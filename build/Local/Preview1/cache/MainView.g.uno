public partial class MainView: Fuse.App
{
    public partial class Factory: Uno.UX.Factory
    {
        ...
        DevOps_Demo_FuseControlsRectangle_Opacity_Property self_Opacity_inst;
        DevOps_Demo_FuseControlsRectangle_Color_Property self_Color_inst;
        DevOps_Demo_FuseControlsRectangle_Height_Property self_Height_inst;
        static Factory()
        {
        }
        public override object New()
        {
            ...
            self_Opacity_inst = new DevOps_Demo_FuseControlsRectangle_Opacity_Property(self);
            self_Color_inst = new DevOps_Demo_FuseControlsRectangle_Color_Property(self);
            self_Height_inst = new DevOps_Demo_FuseControlsRectangle_Height_Property(self);
    ...
    DevOps_Demo_FuseControlsRectangle_Color_Property myRectangle_Color_inst;
    DevOps_Demo_FuseControlsRectangle_CornerRadius_Property myRectangle_CornerRadius_inst;
    DevOps_Demo_FuseReactiveEach_Items_Property temp_Items_inst;
    DevOps_Demo_FuseEffectsBlur_Radius_Property myBlur_Radius_inst;
    ...
    void InitializeUX()
    {
        ...
        myRectangle_Color_inst = new DevOps_Demo_FuseControlsRectangle_Color_Property(myRectangle);
        myRectangle_CornerRadius_inst = new DevOps_Demo_FuseControlsRectangle_CornerRadius_Property(myRectangle);
        __g_nametable = new global::Uno.UX.NameTable(null, __g_static_nametable);
        var temp = new Fuse.Reactive.Each();
        temp_Items_inst = new DevOps_Demo_FuseReactiveEach_Items_Property(temp);
        myBlur = new Fuse.Effects.Blur();
        myBlur_Radius_inst = new DevOps_Demo_FuseEffectsBlur_Radius_Property(myBlur);

public partial class PageWithTitle: Fuse.Controls.Page
{
    ...
    DevOps_Demo_FuseControlsText_Value_Property temp_Value_inst;
    DevOps_Demo_PageWithTitle_Title_Property this_Title_inst;
    DevOps_Demo_FuseControlsText_TextColor_Property temp_TextColor_inst;
    DevOps_Demo_PageWithTitle_HeaderTextColor_Property this_HeaderTextColor_inst;
    DevOps_Demo_FuseControlsPanel_Color_Property temp1_Color_inst;
    DevOps_Demo_PageWithTitle_HeaderColor_Property this_HeaderColor_inst;
    DevOps_Demo_FuseControlsText_Value_Property temp2_Value_inst;
    DevOps_Demo_PageWithTitle_Instructions_Property this_Instructions_inst;
    ...
    void InitializeUX()
    {
        ...
        temp_Value_inst = new DevOps_Demo_FuseControlsText_Value_Property(temp);
        this_Title_inst = new DevOps_Demo_PageWithTitle_Title_Property(this);
        temp_TextColor_inst = new DevOps_Demo_FuseControlsText_TextColor_Property(temp);
        this_HeaderTextColor_inst = new DevOps_Demo_PageWithTitle_HeaderTextColor_Property(this);
        var temp1 = new Fuse.Controls.Panel();
        temp1_Color_inst = new DevOps_Demo_FuseControlsPanel_Color_Property(temp1);
        this_HeaderColor_inst = new DevOps_Demo_PageWithTitle_HeaderColor_Property(this);
        var temp2 = new Fuse.Controls.Text();
        temp2_Value_inst = new DevOps_Demo_FuseControlsText_Value_Property(temp2);
        this_Instructions_inst = new DevOps_Demo_PageWithTitle_Instructions_Property(this);
